...
import com.example.callvideo.Common.GlobalVars;
import com.example.callvideo.R;
import com.example.callvideo.Service.QueryUtils;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.Locale;

import static com.example.callvideo.Common.GlobalVars.BASE_REQ_URL;
import static com.example.callvideo.Common.GlobalVars.DEFAULT_LANG_POS;
...
public class TranslationActivity extends AppCompatActivity implements TextToSpeech.OnInitListener{
        ...
        if (!isOnline()) {
            ...
            mSpinnerLanguageFrom.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    mLanguageCodeFrom = GlobalVars.LANGUAGE_CODES.get(position);
                }
                @Override
            ...
            mSpinnerLanguageTo.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    mLanguageCodeTo = GlobalVars.LANGUAGE_CODES.get(position);
                }
                @Override
                public void onNothingSelected(AdapterView<?> parent) {
                    Toast.makeText(getApplicationContext(), "No option selected", Toast.LENGTH_SHORT).show();
    ...
    private class TranslateText extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... input) {
            ...
            Uri.Builder uriBuilder = baseUri.buildUpon();//Constructs a new builder, copying the attributes from this Uri.
